...
app.get('/repos', async (req, res) => {
  ...
  try{
    ...
    const mapped = out.map(r=>({ name: r.name, full_name: r.full_name, html_url: r.html_url, description: r.description, stargazers_count: r.stargazers_count, forks_count: r.forks_count, open_issues_count: r.open_issues_count, has_pages: r.has_pages, pushed_at: r.pushed_at, owner: { login: r.owner.login } }));
